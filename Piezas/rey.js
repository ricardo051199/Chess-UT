function esMismoColor(x1, y1, x2, y2) {
    const fueraDeRango = [x1, x2, y1, y2].some(val => val > 7 || val < 0);
    return fueraDeRango || matrizTablero[x2][y2].color === matrizTablero[x1][y1].color;
}
...
module.exports = { rey, esMismoColor }